...
class HomeJaiHindCollegePage extends StatefulWidget {
  const HomeJaiHindCollegePage({Key? key}) : super(key: key);

  @override
  _HomeJaiHindCollegePageState createState() =>
      _HomeJaiHindCollegePageState();
}

class _HomeJaiHindCollegePageState
    extends State<HomeJaiHindCollegePage> {
  int _currentIndex = 0;
